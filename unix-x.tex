...
%%NOTE: If you do not have an X-server, you are probably aware of it.
%%NOTE: If you run wayland, you most likely have xwayland. Otherwise, you are again probably aware of it.
