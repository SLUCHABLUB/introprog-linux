...
många fördelar med terminale, till exempel så kan man i ett och samma kommando skicka data
...
Snabbknapparna Ctrl+alt+T brukar också fungera på de flesta linux varianterna.  

När du har lyckats starta en terminal så befinner du dig i din hem-mapp. Med kommandot "ls" kan du läsa vad som finns i mappen. 
...
\emindex{f}, och bakåt med \emindex{b}. För att avsluta less trycker man \emindex{q}.
...
http://www.student.lth.se/datorsupport/utskrifter-skanning-mm/ \\
...
Fsrån programmen kan man oftast skriva ut via menyerna, men för att skriva ut
...
\begin{tabular}{ll}
F/Pi/Nano & \ST{http://www.fsektionen.se/} \\
E & \ST{http://eee.esek.se/} \\
M & \ST{http://www.maskinsektionen.com/} \\
V & \ST{http://www.v-sektionen.se/} \\
...
\begin{exercise}
  ...
  igenom genom att skriva \ST{xcalc \&}. Kontrollera att du
...
\begin{exercise}
  ...
  \ST{dat12nka@student.lu.se}. Skriv lite synpunkter på handledningen så att
